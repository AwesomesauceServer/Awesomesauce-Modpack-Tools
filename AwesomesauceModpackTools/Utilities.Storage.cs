...
namespace AwesomesauceModpackTools {
    ...
    public static partial class Utilities {
        ...
        public static class Storage  {
            ...
            private static string _UserAgent = $"{AppName}/{Version.Parse(System.Windows.Forms.Application.ProductVersion).ToString(3)} (compatible; {Environment.OSVersion.ToString().Replace("Microsoft ", "")}; {((Environment.Is64BitOperatingSystem) ? "x64" : "x86")}; Trident/7.0) (+https://git.io/vQ6dQ)";
            /// <summary>
